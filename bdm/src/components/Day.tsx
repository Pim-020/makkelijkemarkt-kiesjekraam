  ...
  lotChanged = (lot: Lot | undefined) => {
    if (lot) {
      ...
      if (this.state.currentPosition) {
        _marketEventDetails.pages[this.state.currentPosition[0]].layout[this.state.currentPosition[1]].lots[
      ...
      <>
        ...
        >
          {this.state.marketEventDetails.pages.map((page: MarketPage, i: number) => {
            ...
            return (
              <TabPane tab={this.getPageTitle(page)} key={i}>
                <>
                  <Input
                    type="text"
                ...
                <div className="block-wrapper">
                  {page.layout &&
                    ...
                    page.layout.map((layout: MarketLayout, i: number) => {
                      const layoutindex = i
                      return (
                        <div key={layout._key} className={this.getRowClass(layout)}>
        ...
        <LotEdit
          ...
          changed={this.lotChanged}
          delete={this.lotDelete}
          prepend={this.lotPrepend}
          append={this.lotAppend}
        />
      </>
    )
  }
