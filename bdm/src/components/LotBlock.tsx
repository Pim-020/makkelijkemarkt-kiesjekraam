...
export default class LotBlock extends Component<{
  ...
  render() {
    ...
    return (
      <div key={index} className={classDef} onClick={lotOnClick}>
        {lot.type === 'stand' && <Stand stand={lot} invert={invert} branche={branche} classDef={classDef} />}
        {lot.type === 'obstacle' && <Obstacle obstacle={lot} invert={invert} classDef={classDef} />}
      </div>
    )
  }
}
